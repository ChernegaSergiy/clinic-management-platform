...
class AdminScheduleController extends \App\Core\Controller\AbstractController
{
    ...
    public function adminDeleteException() : Response
    {
        ...
        if ($targetDoctorId === (int)$_SESSION['user']['id'] || $this->gate->allows('schedules.manage_all')) {
